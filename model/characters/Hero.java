...
public abstract class Hero extends Character{ //changed abstract pub to pub abstract for convention
	...
	public void attack() throws NotEnoughActionsException, InvalidTargetException{
        if (this.getTarget() instanceof Hero){//||
            ...
            throw new InvalidTargetException("You can't hit air,Select a Target first");
        }
	...
	public void cure() throws NotEnoughActionsException, InvalidTargetException, NoAvailableResourcesException{
        if (this.getTarget() == null)
            throw new InvalidTargetException("Select a zombie first please");
    if (!this.isAdjacent(this.getTarget()))
        throw new InvalidTargetException("Target isn't close enough!");
    ...
    if(this.getVaccineInventory().size() <= 0)
        throw new NoAvailableResourcesException("You don't have enough vaccines to cure!");//////////////apparently PRIV TESTS FAILURE M3 EN WE COVER IT F VACCINE/////////////////////////
...
//        }//added this
	...
	public void move(Direction d) throws MovementException, NotEnoughActionsException {
		...
		if ((Game.map[h][w] instanceof CollectibleCell)) {
			...
			a.setContentText("You stepped in a trap cell! " + dmg + " Damage Taken");
			a.show();
